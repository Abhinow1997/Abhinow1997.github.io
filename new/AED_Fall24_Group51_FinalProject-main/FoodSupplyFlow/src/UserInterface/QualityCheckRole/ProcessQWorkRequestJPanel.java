...
public class ProcessQWorkRequestJPanel extends javax.swing.JPanel {
 ...
 public void populateTable() {
    ...
    private void initComponents() {
        ...
        radioQ1No.setForeground(new java.awt.Color(242, 242, 242));
        ...
        jLabel8.setText("Quality Indicator");

        radioQ3Yes.setForeground(new java.awt.Color(242, 242, 242));
        ...
        radioQ1Yes.setForeground(new java.awt.Color(242, 242, 242));
        ...
        radioQ2No.setForeground(new java.awt.Color(242, 242, 242));
        ...
        radioQ2Yes.setForeground(new java.awt.Color(242, 242, 242));
        ...
        radioQ3No.setForeground(new java.awt.Color(242, 242, 242));
        ...
        radioQ6No.setForeground(new java.awt.Color(242, 242, 242));
        ...
        jLabel21.setText("Is the labeling accurate and compliant with regulations?");

        radioQ7No.setForeground(new java.awt.Color(242, 242, 242));
        ...
        jLabel15.setText("Was proper storage temperature maintained?");

        radioQ7Yes.setForeground(new java.awt.Color(242, 242, 242));
        ...
        jLabel2.setText("Is the food free from signs of contamination?");
        ...
        jLabel11.setText("Were hygiene standards maintained during handling?");

        qualityCheckReport.setColumns(20);
        qualityCheckReport.setRows(5);
        jScrollPane1.setViewportView(qualityCheckReport);

        radioQ4No.setForeground(new java.awt.Color(242, 242, 242));
        ...
        radioQ4Yes.setForeground(new java.awt.Color(242, 242, 242));
        ...
        jLabel13.setText("Is the packaging intact and secure?");

        radioQ5Yes.setForeground(new java.awt.Color(242, 242, 242));
        ...
        radioQ5No.setForeground(new java.awt.Color(242, 242, 242));
        ...
        jLabel17.setText("Does the product comply with its expiry date?");

        radioQ6Yes.setForeground(new java.awt.Color(242, 242, 242));
        ...
        jLabel19.setText("Are the ingredients sourced from verified suppliers?");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addGap(58, 58, 58)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(submitJButton, javax.swing.GroupLayout.DEFAULT_SIZE, 487, Short.MAX_VALUE)
