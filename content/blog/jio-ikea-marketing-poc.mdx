...
date: "2024-04-02"
slug: "jio-ikea-notifications-poc"
description: "Developing a real-time streaming pipeline using 4G/5G LSR data to boost IKEA's walk-in sales through geo-targeted discount coupons"
---
...
An interesting streaming requirement emerged at Jio Platforms. We needed to develop a proof of concept (PoC) pipeline and workflow for a unique client: IKEA.
...
![IKEA Cities](content\blog\images\geo_hashing.png)
...
![LSR Simplified Flow](lsr_simplified_flow.png)
...
![Geo Hashing](/image/geo_hashing.png)
