...
date: "2024-11-12"
slug: "rss-news-sentiment-analysis"
description: "A daily-updated dashboard analyzing sentiment in news articles from various broadcasters using RSS feeds, VADER sentiment analysis, and Streamlit"
---
...
![News Sentiment Flow](https://github.com/user-attachments/assets/6d8f6b25-4c24-4723-b942-83fd67fe035d)
...
The live dashboard can be accessed at: [RSS News Sentiment Analysis Dashboard](https://rssnewssentimentanalysisdaily.streamlit.app)